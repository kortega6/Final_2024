...
```{r}
barchartGC(~infected + sex,data=Male)
barchartGC(~infected + sex,data=Male, type="percent")

```
From this bar chart, there doesn't doesn't seem to be any significant change in likelihood of contracting covid for men who have taken the vaccine. 
